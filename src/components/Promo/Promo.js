  ...
  return (
    <section style={{display: "flex", justifyContent: "center",marginTop: "6rem"}}>
        <div className='course-info-banner'>
            ...
            <br/>
            <p style={{width: "65%"}}className='secondary-color'>একজন দক্ষ প্রোগ্রামার হওয়ার যাত্রা শুর করতে চাইলে এই কোর্সে জয়েন করো| শিখতে গেলে যা যা লাগবে সেগুলো প্রোভাইড করব আমরা
